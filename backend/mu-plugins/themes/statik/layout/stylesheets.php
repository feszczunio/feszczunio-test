...
$isLogged = \function_exists('is_user_logged_in')
    && \is_user_logged_in()
    && false === \defined('STATIK_ERROR_PAGE');
...
<style>
    ...
    body {
        ...
        width: 100%;
        min-height: <?= $isLogged ? 'calc(100vh - 32px)' : '100vh'; ?>;
        padding: 0;
        margin: 0;
    ...
    .wrapper {
        ...
        padding: <?= $isLogged ? '4px 0 50px' : '50px 0'; ?>;
        width: 100vw;
    }
    ...
    p, .wp-die-message, a[href="javascript:history.back()"] {
        font-family: var(--font-family);
        font-style: normal;
        font-weight: 400;
        font-size: 1.4em;
    ...
    @media screen and (max-width: 782px) {
        ...
        body {
            min-height: <?= $isLogged ? 'calc(100vh - 46px)' : '100vh'; ?>;
        }
    ...
    @media screen and (min-width: 783px) {
        ...
        .wrapper {
            min-height: calc(100vh - 200px);
            padding: <?= $isLogged ? '18px 0 50px' : '50px 0'; ?>;
            justify-content: center;
        }
