 ...
 */
import migrateFontFamily from '../../../core/utils/migrate-font-family';
...
const v10 = {
	...
	supports: {
		...
		__experimentalSelector: '.wp-block-statik-video-button__link',
	},
...
const deprecated = [
	...
	},
	{
		...
		save( { attributes } ) {
			...
			const linkClass = 'wp-block-statik-video-button__link';
